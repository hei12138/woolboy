...
public class ImageOutputMessage extends OutputMessage {
     ...
     * 通过上传多媒体文件，得到的id
     */
    private org.weixin4j.model.message.Image Image;
     ...
     * @param image 图片
     */
    public ImageOutputMessage(org.weixin4j.model.message.Image image) {
        this.Image = image;
    }
     ...
     */
    public org.weixin4j.model.message.Image getImage() {
        return this.Image;
    }
     ...
     */
    public void setImage(org.weixin4j.model.message.Image image) {
        this.Image = image;
    }
