...
public class VideoOutputMessage extends OutputMessage {
     ...
     * 通过上传多媒体文件，得到的id
     */
    private org.weixin4j.model.message.Video Video;
     ...
     * @param video 视频
     */
    public VideoOutputMessage(org.weixin4j.model.message.Video video) {
        Video = video;
    }
     ...
     */
    public org.weixin4j.model.message.Video getVideo() {
        return Video;
    }
     ...
     */
    public void setVideo(org.weixin4j.model.message.Video video) {
        Video = video;
    }
