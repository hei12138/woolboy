...
public class NewsOutputMessage extends OutputMessage {
     ...
     */
    private List<org.weixin4j.model.message.Articles> Articles;
     ...
     */
    public List<org.weixin4j.model.message.Articles> getArticles() {
        return Articles;
    }
     ...
     */
    public void setArticles(List<org.weixin4j.model.message.Articles> articles) {
        if (articles != null) {
            if (articles.size() > 10) {
                articles = new ArrayList<org.weixin4j.model.message.Articles>(articles.subList(0, 10));
            }
    ...
    public String toXML() {
        ...
        sb.append("<Articles>");
        for (org.weixin4j.model.message.Articles article : Articles) {
            sb.append("<item>");
